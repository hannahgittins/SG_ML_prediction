...
def test_model(
    ...
    # print(f"Accuracy for top 1: {acc_dict[1]*100:.4f}\nAccuracy for top 3: {acc_dict[3]*100:.4f}\nAccuracy for top 5: {acc_dict[5]*100:.4f}\nAccuracy for top 10: {acc_dict[10]*100:.4f}\n")
...
if __name__ == "__main__":
    ...
    model_file_path = f"/scratch/hs9g19/GNN_store/best_gnn_model_ddp_test_{file_num}.pt"
    output = f"/scratch/hs9g19/GNN_store/best_gnn_model_{file_num}_output.txt"
